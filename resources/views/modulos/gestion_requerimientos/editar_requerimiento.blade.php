                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-content collapse show">
                                <form id="form_crear_requerimiento" class="form" action="{{ route('editar_requerimientos') }}" method="POST">
                                    @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $requerimiento->nombre }}" placeholder="Ingrese el nombre del requerimiento" autocomplete="off" type="text" class="form-control border-primary @error('nombre') is-invalid @enderror" name="nombre" id="nombre">
                                                    @error('nombre')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ date("Y-m-d", strtotime($requerimiento->fecha_finalizacion)) }}" autocomplete="off" type="date" class="form-control border-primary @error('fecha_finalizacion') is-invalid @enderror" name="fecha_finalizacion" id="fecha_finalizacion">
        ...
        $('#fecha_finalizacion').on("blur", function(){
            ...
            if(fecha_actual >= fecha_finalizacion){
                Swal.fire({
                    ...
                    footer: '<strong>Nota:</strong><p>&nbspActualiza la fecha y da click fuera del campo de texto</p>'
                });
