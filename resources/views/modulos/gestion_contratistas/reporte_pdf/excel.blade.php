<table>
    <thead>
        ...
        <tr>
            <th style="width: 18px; text-align: center;"><strong>Tipo documento</strong></th>
    ...
    <tfoot>
        ...
        <tr>
            <th colspan="2" align="left"><img width="30" height="30" src="./dashboard/assets/img/logo.png" alt="Logo"></th>
            <th colspan="14">VersatileReports Copyright © 2021 Todos los derechos reservados</th>
        </tr>
    </tfoot>
</table>