                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Editar evidencia
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Editar evidencia</h4>
                        ...
                        <div class="card-body">
                            <div class="card-content collapse show">
                                <form id="form_editar_evidencias" class="form" action="{{ route('editar_evidencias') }}" method="POST">
                                    @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $evidencia->detalle }}" autocomplete="off" type="text" class="form-control border-primary @error('detalle') is-invalid @enderror" name="detalle" id="detalle">
                                                    @error('detalle')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control border-primary @error('id_actividad') is-invalid @enderror" name="id_actividad" id="id_actividad">
                                                        ...
                                                        @foreach ($actividades as $item)
                                                            <option {{ $item->id_actividad == $evidencia->id_actividad ? 'selected' : '' }} value="{{ $item->id_actividad }}">{{ $item->detalle }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('id_actividad')
                                                        <div class="invalid-feedback">{{ $message }}</div>
...
<script>
    $(document).ready(function() {
        $("#form_editar_evidencias").validate({
            rules: {
                detalle : {
                  required: true,
                  minlength: 3
