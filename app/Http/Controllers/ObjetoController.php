...
class ObjetoController extends Controller
{
    public function view_list(){
        return view('modulos.parametrizaciones.gestion_objetos_contratos.listar_obj_contratos');
    }

    public function view_create(){
        return view('modulos.parametrizaciones.gestion_objetos_contratos.crear_obj_contrato');
    }
    
    public function view_edit($id){
        $objeto = Objeto::find($id);
        return view('modulos.parametrizaciones.gestion_objetos_contratos.editar_obj_contrato', compact('objeto'));
    }
