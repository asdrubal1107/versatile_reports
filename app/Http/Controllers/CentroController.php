...
class CentroController extends Controller
{
    public function view_list(){
        return view('modulos.parametrizaciones.gestion_centros.listar_centros');
    }

    public function view_edit($id){
        $centro = Centro::find($id);
        return view('modulos.parametrizaciones.gestion_centros.editar_centros', compact("centro"));
    }

    public function view_create(){
        return view('modulos.parametrizaciones.gestion_centros.crear_centros');
    }
